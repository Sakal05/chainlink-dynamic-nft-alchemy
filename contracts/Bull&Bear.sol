...
contract BullBear is ERC721, ERC721Enumerable, ERC721URIStorage, KeeperCompatibleInterface, Ownable  {
    ...
    string[] bullUrisIpfs = [
        ...
        "https://ipfs.io/ipfs/QmbKhBXVWmwrYsTPFYfroR2N7NAekAMxHUVg2CWks7i9qj?filename=simple_bull.json"
    ];
    string[] bearUrisIpfs = [
...
// set the price feed address to
    ...
    //function to update the uri of each token
    function updateAllTokenUris(string memory trend) internal {
         if (compareStrings("bear", trend)) {
            console.log("UPDATE TOKEN URI WITH", "bear", trend);
   ...
   function checkUpkeep(bytes calldata /* checkData */) external view override returns (bool upkeepNeeded, bytes memory /*performData */) {
    ...
    /*
    create a function to perform up keep using chainlink library of KeeperCompatible
    */
